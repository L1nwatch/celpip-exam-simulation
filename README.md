...
Existing whole-section review marks are converted once into reviewed marks for every part in that section. Each part can then be unmarked independently.
