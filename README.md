...
Use **☆ Mark Listening reviewed** in the top-right corner of any Listening part to mark the entire Listening section of that test as reviewed. Reading, Writing, and Speaking each have their own section mark. Click the button again to undo. The overview shows a star and **Reviewed** for that test section. Review marks are saved to SQLite across browsers independently of answers and scores; the public demo saves them in the current browser only.
